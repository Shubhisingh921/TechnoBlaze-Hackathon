<?php
    ...
    session_start();
 	...
 	header("Content-Type: text/html;charset=UTF-8");
		...
		if($_SERVER['HTTP_HOST']=="localhost" or $_SERVER['HTTP_HOST']=="sql6.freemysqlhosting.net")
		{	
			//local  

				 DEFINE ('DB_USER', 'sql6580480');
				 DEFINE ('DB_PASSWORD', 'STcc6F8XsM');
				 DEFINE ('DB_HOST', 'sql6.freemysqlhosting.net'); //host name depends on server
				 DEFINE ('DB_NAME', 'sql6580480');
		}
		else
		{
			//local live 
